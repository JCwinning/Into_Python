...
class Secrets
{
	...
	protected $notificationEmail = 'TonyJCing@outlook.com';

	// E-mail address to use in notifications to normal users
	protected $noreplyEmail = 'TonyJCing@outlook.com';

	// Unique encryption key (case-sensitive)
	protected $encryptionKey = 'qwe123qwe';

	// Login name to gain admin rights (case-sensitive)
	protected $adminName = 'TonyJCing';

	// Login password to gain admin rights (case-sensitive)
	protected $adminPassword = 'werwerwerwer';
